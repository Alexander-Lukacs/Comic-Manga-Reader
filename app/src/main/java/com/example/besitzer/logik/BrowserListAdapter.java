...
public class BrowserListAdapter extends ArrayAdapter<String> {
    ...
    public BrowserListAdapter(Activity context, String[] itemname, Integer[] imgid) {
        super(context, R.layout.browser_list, itemname);
    ...
    public View getView(int position,View view,ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.browser_list, null,true);
